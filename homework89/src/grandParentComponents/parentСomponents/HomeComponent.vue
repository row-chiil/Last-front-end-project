...
<div>
    <div v-if="!isAut" class="logInOrSingUp">
        ...
        <div v-if="isLogIn" class="Forma">
            <input type="text" placeholder="Введите ник" v-model="DataUserForLogIn.userName">
        ...
        <div v-else class="Forma">
            <input type="text" placeholder="Придумайте ник" v-model="DataUserForPost.newUserName">
